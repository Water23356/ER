...
namespace ER
{
    ...
    public struct UIDObjectInfo
    {
        ...
        /// 一个空的无效的信息
        /// </summary>
        public static UIDObjectInfo Empty => new UIDObjectInfo() { uuid=null,data=null};

        public UIDObjectInfo(string _uuid)
        {
            uuid = _uuid;
            data = new Dictionary<string, object>();
        }
        public UIDObjectInfo(UID uid)
        {
            uuid = uid.ToString();
            data = new Dictionary<string, object>();
        }
    ...
    public interface IUIDObject
    {
        ...
        /// </summary>
        /// <returns></returns>
        public UIDObjectInfo Serialize();
        /// <summary>
        /// 根据文本反序列化
        /// </summary>
        /// <param name="data"></param>
        public void Deserialize(UIDObjectInfo data);
    }
}